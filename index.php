...
if (isset($_POST['search'])) {
    if (!empty($_POST['searchcaption'])) {
        ...
        header("Location: page/search.php?post=" . urlencode($search));
        exit;
    } else {
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <?php if (isset($_SESSION['login'])) { ?>
                    ...
                    <a class="nav-link " href="page/exit.php" id="navbarDropdown" role="button"
    ...
    <div>
        <div class="row d-none d-lg-flex">
            ...
            <div class="col-4 information-site">
                ...
                <span>نویسندگان ما <?php echo $numwriter; ?></span>
            </div>
            <div class="col-4 information-site">
                <img src="image/stat-student.svg" alt="">
                <span>تعداد کاربران <?php echo $numuser; ?></span>
            </div>
        </div>
    </div>
    <!-- end content -->
                ...
                <div class="post-item">
                    <a href="" class="item-hover-btn"><img src="admin/page/uploads/<?php foreach ($images as $image){
                        ...
                        <div class="hovershow">
                            ...
                            <a href="page/single.php?post=<?php echo $post['title'];?>" class="more-opst btn d-none d-lg-flex">مشاهده ی مقاله</a>
                        </div>
                    </a>
